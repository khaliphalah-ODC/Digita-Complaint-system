export const Department = `CREATE TABLE IF NOT EXISTS department (
   ...
   FOREIGN KEY (accessmentId) REFERENCES accessment(id)

)`;

export const insertDepartment = `INSERT INTO department (organization_id,name, description, accessmentId) VALUES (?, ?, ?, ?)`;
...
export const updateDepartmentById = `UPDATE department SET organization_id = ?, name = ?, description = ?, accessmentId = ?, departmentId = ? WHERE departmentId = ?`;
