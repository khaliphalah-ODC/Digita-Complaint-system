...
>>>>>>> Stashed changes:frontend/src/pages/OrganizationPage.vue
    ...
    <section v-else-if="!loading && hasOrganization" :class="panelClass">
      <h2 :class="isUserWorkspace ? 'text-xl font-semibold text-[var(--app-primary-ink)]' : 'text-xl font-semibold text-white'">Organization Detail</h2>
      <p :class="isUserWorkspace ? 'mt-1 text-[0.98rem] text-[var(--app-muted-color)]' : 'mt-1 text-[0.98rem] text-white/80'">This is your organization record.</p>

      <div class="mt-4 grid gap-4 md:grid-cols-2">
        <div :class="cardClass">
          <p :class="isUserWorkspace ? 'text-xs font-semibold uppercase tracking-[0.12em] text-[var(--app-muted-color)]' : 'text-xs font-semibold uppercase tracking-[0.12em] text-white/70'">Name</p>
        ...
        <div :class="cardClass">
          <p :class="isUserWorkspace ? 'text-xs font-semibold uppercase tracking-[0.12em] text-[var(--app-muted-color)]' : 'text-xs font-semibold uppercase tracking-[0.12em] text-white/70'">Type</p>
        ...
        <div :class="cardClass">
          <p :class="isUserWorkspace ? 'text-xs font-semibold uppercase tracking-[0.12em] text-[var(--app-muted-color)]' : 'text-xs font-semibold uppercase tracking-[0.12em] text-white/70'">Email</p>
        ...
        <div :class="cardClass">
          <p :class="isUserWorkspace ? 'text-xs font-semibold uppercase tracking-[0.12em] text-[var(--app-muted-color)]' : 'text-xs font-semibold uppercase tracking-[0.12em] text-white/70'">Phone</p>
        ...
        <div :class="`${cardClass} md:col-span-2`">
          <p :class="isUserWorkspace ? 'text-xs font-semibold uppercase tracking-[0.12em] text-[var(--app-muted-color)]' : 'text-xs font-semibold uppercase tracking-[0.12em] text-white/70'">Address</p>
      ...
      <div class="mt-4 flex flex-wrap gap-2">
        <span :class="isUserWorkspace ? 'app-badge app-badge-neutral' : 'app-badge bg-white/10 text-white/90'">
